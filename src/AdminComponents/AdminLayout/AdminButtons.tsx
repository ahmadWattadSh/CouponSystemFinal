...
const AdminButtons = (props: Props) => {
  ...
  // This changes the action to "all companies" in the adminDashboard by lift-up
  ...
  // This changes the action to "all Customers" in the adminDashboard by lift-up
  ...
  // This changes the action to "Profile" in the adminDashboard by lift-up
