/** 
 * This component is resposible for displaying all the coupons belonging to the logged in company 
...
const ShowCoupons: React.FC<Props> = (props) => {
  ...
  /* displaying all the coupons that belong to the logged in company */
  ...
  /*deleting the desired coupon from the UI */
  ...
  /*getting the coupons that belong to the company, all the coupons / coupons filtered by maxPrice / coupons filtered by category 
