/**
 * This component is resposible on adding a new coupon to the logged in company  in the backend and the frontend
 */
...
const AddCoupon: React.FC<Props> = (props) => {
  ...
  /* This is resposible for opening the drawer*/
  ...
  /*Posting the coupon to the backend  - if there is an error the user will be sent to the error page*/
