/**
 * This component functions as a customers' data passage it passes the data from the ShowCustomers component to 
 * the CustomerModel component through the props
 */
